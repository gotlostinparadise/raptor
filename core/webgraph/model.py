...
PROOF_TOKEN_ANALYSIS = "token_analysis"    # auth: deterministic weakness in issued session tokens
...
__all__ = [
    ...
    "PROOF_STATE_ORACLE", "PROOF_TOKEN_FORGED", "PROOF_TOKEN_ANALYSIS", "PROOF_NONE",
    # records
